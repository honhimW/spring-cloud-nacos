...
import io.github.honhimw.scn.it.RNacosContainer;
...
/// @author honhimW
/// @since 2025-12-22
public class SDKTests extends AbstractNacosContainerTest {
	...
	void listener() throws Exception {
		...
		properties.put(PropertyKeyConst.SERVER_ADDR, nacos.serverAddr());
