...
import io.github.honhimw.scn.config.parser.NacosDataParserHandler;
...
import static io.github.honhimw.scn.config.configdata.ConfigPreference.LOCAL;
import static io.github.honhimw.scn.config.configdata.ConfigPreference.REMOTE;
 ...
 * @since 2021.0.1.0
 */
public class NacosConfigDataLoader implements ConfigDataLoader<@NonNull NacosConfigDataResource> {
	...
	@Override
	public ConfigData load(@NonNull ConfigDataLoaderContext context,
	...
	public ConfigData doLoad(ConfigDataLoaderContext context,
		...
		try {
			...
			List<PropertySource<?>> propertySources = pullConfig(nacosConfigManager.getConfigService(),
