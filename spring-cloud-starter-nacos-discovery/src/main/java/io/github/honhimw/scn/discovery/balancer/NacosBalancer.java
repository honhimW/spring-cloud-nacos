...
package io.github.honhimw.scn.discovery.balancer;
...
import io.github.honhimw.scn.discovery.NacosServiceInstance;
import io.github.honhimw.scn.discovery.loadbalancer.NacosLoadBalancer;
...
public class NacosBalancer extends Balancer {
	...
	public static ServiceInstance getHostByRandomWeight3(
		...
		if (StringUtils.hasText(NacosLoadBalancer.ipv6)) {
