...
class TestingCfgPlugin implements Plugin<Project> {
    ...
    void apply(Project project) {
        project.dependencies { DependencyHandler dep ->
			...
			libs.findLibrary('lombok').ifPresent {
				dep.add JavaPlugin.TEST_COMPILE_ONLY_CONFIGURATION_NAME, it
				dep.add JavaPlugin.TEST_ANNOTATION_PROCESSOR_CONFIGURATION_NAME, it
			}
