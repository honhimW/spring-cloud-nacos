...
package io.github.honhimw.nacos.client.logging;

import io.github.honhimw.nacos.client.env.NacosClientProperties;
import io.github.honhimw.nacos.common.executor.ExecutorFactory;
import io.github.honhimw.nacos.common.executor.NameThreadFactory;
import io.github.honhimw.nacos.common.logging.NacosLoggingAdapter;
import io.github.honhimw.nacos.common.logging.NacosLoggingAdapterBuilder;
import io.github.honhimw.nacos.common.logging.NacosLoggingProperties;
    ...
    private void scheduleReloadTask() {
        ScheduledExecutorService reloadContextService = ExecutorFactory.Managed
                .newSingleScheduledExecutorService("Nacos-Client",
                        new NameThreadFactory("io.github.honhimw.nacos.client.logging"));
