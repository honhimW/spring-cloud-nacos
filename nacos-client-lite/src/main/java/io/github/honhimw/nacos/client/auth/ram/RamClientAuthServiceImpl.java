...
package io.github.honhimw.nacos.client.auth.ram;

import io.github.honhimw.nacos.api.PropertyKeyConst;
import io.github.honhimw.nacos.api.exception.NacosException;
import io.github.honhimw.nacos.client.auth.ram.identify.StsConfig;
import io.github.honhimw.nacos.client.auth.ram.injector.AbstractResourceInjector;
import io.github.honhimw.nacos.client.auth.ram.injector.AiResourceInjector;
import io.github.honhimw.nacos.client.auth.ram.injector.ConfigResourceInjector;
import io.github.honhimw.nacos.client.auth.ram.injector.LockResourceInjector;
import io.github.honhimw.nacos.client.auth.ram.injector.NamingResourceInjector;
import io.github.honhimw.nacos.client.auth.ram.utils.RamUtil;
import io.github.honhimw.nacos.client.auth.ram.utils.SpasAdapter;
import io.github.honhimw.nacos.common.utils.StringUtils;
import io.github.honhimw.nacos.plugin.auth.api.LoginIdentityContext;
import io.github.honhimw.nacos.plugin.auth.api.RequestResource;
import io.github.honhimw.nacos.plugin.auth.constant.SignType;
import io.github.honhimw.nacos.plugin.auth.spi.client.AbstractClientAuthService;
