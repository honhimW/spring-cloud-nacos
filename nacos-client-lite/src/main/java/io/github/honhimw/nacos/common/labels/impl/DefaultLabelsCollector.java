...
package io.github.honhimw.nacos.common.labels.impl;

import io.github.honhimw.nacos.api.common.Constants;
import io.github.honhimw.nacos.common.labels.LabelsCollector;
import io.github.honhimw.nacos.common.utils.ConnLabelsUtils;
...
import static io.github.honhimw.nacos.api.common.Constants.DOT;
import static io.github.honhimw.nacos.api.common.Constants.ENV_KEY;
import static io.github.honhimw.nacos.api.common.Constants.JVM_KEY;
...
public class DefaultLabelsCollector implements LabelsCollector {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger("io.github.honhimw.nacos.common.labels");
