...
package io.github.honhimw.nacos.api.selector.context;

import io.github.honhimw.nacos.api.selector.Selector;
...
public interface SelectorContextBuilder<T, C, P> {
     ...
     * we provide {@link CmdbContext} for user default who want to use the {@link io.github.honhimw.nacos.api.naming.pojo.Instance}'s CMDB info.
     *
