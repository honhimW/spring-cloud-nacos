...
package io.github.honhimw.nacos.client.naming.remote.gprc.redo;
...
import io.github.honhimw.nacos.client.naming.remote.gprc.redo.data.SubscriberRedoData;
...
import io.github.honhimw.nacos.common.remote.client.ConnectionEventListener;
 ...
 * TODO refactor to extends from {@link io.github.honhimw.nacos.client.redo.service.AbstractRedoService}
 *
 * @author xiweng.yy
 */
public class NamingGrpcRedoService implements ConnectionEventListener {
    
    private static final String REDO_THREAD_NAME = "io.github.honhimw.nacos.client.naming.grpc.redo";
