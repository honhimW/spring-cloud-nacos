...
package io.github.honhimw.nacos.client.lock;
...
import io.github.honhimw.nacos.client.lock.remote.grpc.LockGrpcClient;
...
public class NacosLockService implements LockService {
    ...
    private void initSecurityProxy(NacosClientProperties properties) {
        this.executorService = new ScheduledThreadPoolExecutor(1, r -> {
            ...
            t.setName("io.github.honhimw.nacos.client.lock.security");
            t.setDaemon(true);
            return t;
        });
