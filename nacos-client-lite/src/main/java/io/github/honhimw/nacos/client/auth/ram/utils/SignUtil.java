...
package io.github.honhimw.nacos.client.auth.ram.utils;

import io.github.honhimw.nacos.common.codec.Base64;
...
public class SignUtil {
    ...
    static byte[] sign(byte[] data, byte[] key, SigningAlgorithm algorithm) throws Exception {
        try {
