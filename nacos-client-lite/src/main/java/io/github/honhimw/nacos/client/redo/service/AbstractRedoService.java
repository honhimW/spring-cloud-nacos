...
package io.github.honhimw.nacos.client.redo.service;
...
import io.github.honhimw.nacos.client.redo.data.RedoData;
...
public abstract class AbstractRedoService implements ConnectionEventListener, Closeable {
    ...
    private static final String REDO_THREAD_NAME_PATTERN = "io.github.honhimw.nacos.client.%s.redo";
