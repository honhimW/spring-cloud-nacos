...
public class NetUtils {
    ...
    private static final String CLIENT_LOCAL_IP_PROPERTY = "io.github.honhimw.nacos.client.local.ip";
    
    private static final String CLIENT_LOCAL_PREFER_HOSTNAME_PROPERTY = "io.github.honhimw.nacos.client.local.preferHostname";
