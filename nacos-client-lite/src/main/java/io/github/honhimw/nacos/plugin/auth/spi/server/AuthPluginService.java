...
package io.github.honhimw.nacos.plugin.auth.spi.server;

import io.github.honhimw.nacos.plugin.auth.api.AuthResult;
import io.github.honhimw.nacos.plugin.auth.api.IdentityContext;
import io.github.honhimw.nacos.plugin.auth.api.Permission;
import io.github.honhimw.nacos.plugin.auth.api.Resource;
import io.github.honhimw.nacos.plugin.auth.constant.ActionTypes;
import io.github.honhimw.nacos.plugin.auth.exception.AccessException;
...
public interface AuthPluginService {
     ...
     * @param type   type of request, see {@link io.github.honhimw.nacos.plugin.auth.constant.SignType}
