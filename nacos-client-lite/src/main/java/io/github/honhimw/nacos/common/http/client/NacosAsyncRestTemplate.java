...
import io.github.honhimw.nacos.common.http.Callback;
...
import io.github.honhimw.nacos.common.http.client.request.AsyncHttpClientRequest;
...
public class NacosAsyncRestTemplate extends AbstractNacosRestTemplate {
     ...
     * @param callback     callback {@link Callback#onReceive(io.github.honhimw.nacos.common.model.RestResult)}
     */
