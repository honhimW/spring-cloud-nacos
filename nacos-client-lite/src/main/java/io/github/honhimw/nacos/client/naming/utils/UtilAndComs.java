...
public class UtilAndComs {
    ...
    @Deprecated
    public static final String NACOS_NAMING_LOG_NAME = "io.github.honhimw.nacos.naming.log.filename";
    
    @Deprecated
    public static final String NACOS_NAMING_LOG_LEVEL = "io.github.honhimw.nacos.naming.log.level";
