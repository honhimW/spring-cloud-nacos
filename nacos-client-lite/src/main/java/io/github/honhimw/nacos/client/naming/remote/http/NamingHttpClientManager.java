...
import io.github.honhimw.nacos.common.tls.TlsSystemConfig;
...
public class NamingHttpClientManager implements Closeable {
    ...
    private static final int READ_TIME_OUT_MILLIS = Integer
            .getInteger("io.github.honhimw.nacos.client.naming.rtimeout", 50000);
    
    private static final int CON_TIME_OUT_MILLIS = Integer.getInteger("io.github.honhimw.nacos.client.naming.ctimeout", 3000);
