...
package io.github.honhimw.nacos.common.trace.publisher;

import io.github.honhimw.nacos.api.exception.NacosException;
import io.github.honhimw.nacos.common.notify.Event;
import io.github.honhimw.nacos.common.notify.ShardedEventPublisher;
...
public class TraceEventPublisher extends Thread implements ShardedEventPublisher {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger("io.github.honhimw.nacos.common.trace.publisher");
